...
// RestAssured Dependency in pom file
...
public class HamcrestMatcherTest {
    ...
    public void test1(){
        ...
        // adding error message if it fails
       // assertThat("Wrong Result!",1+3,is(6));

        // test 1+3 is not 5
        assertThat(1+3,not(7));
        // we can nest matcher inside of another matcher
        assertThat(1+3,not(equalTo(2)));
